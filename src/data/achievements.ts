...
const catAch = (cat: CategoryId, name: string, icon: string): AchievementDef => ({
  id: `esp-${cat}`,
  name,
  desc: `Acerte 100 questões de ${cat === 'GO' ? 'GO' : cat === 'CLI' ? 'Clínica' : cat === 'CIR' ? 'Cirurgia' : cat === 'PRE' ? 'Preventiva' : 'Pediatria'}.`,
  icon,
  xp: 400,
  coins: 200,
...
export const ACHIEVEMENTS: AchievementDef[] = [
  { id: 'first-answer', name: 'Primeiro plantão', desc: 'Responda sua primeira questão.', icon: '🩺', xp: 20, coins: 20, check: (s) => s.answered >= 1 },
  ...
  { id: 'q-100', name: '100 questões', desc: 'Responda 100 questões.', icon: '📘', xp: 150, coins: 80, check: (s) => s.answered >= 100, progress: (s) => [s.answered, 100] },
  { id: 'q-500', name: '500 questões', desc: 'Responda 500 questões.', icon: '📗', xp: 500, coins: 250, check: (s) => s.answered >= 500, progress: (s) => [s.answered, 500] },
  { id: 'q-1000', name: '1000 questões', desc: 'Responda 1000 questões.', icon: '📕', xp: 1000, coins: 500, check: (s) => s.answered >= 1000, progress: (s) => [s.answered, 1000] },
  ...
  { id: 'perfect', name: 'Gabaritou!', desc: 'Termine uma partida sem errar nenhuma questão.', icon: '💯', xp: 200, coins: 100, check: (s) => s.perfectMatches >= 1 },
  ...
  { id: 'hard-25', name: 'Casca grossa', desc: 'Acerte 25 questões difíceis ou muito difíceis.', icon: '🧗', xp: 300, coins: 150, check: (s) => s.hardCorrect >= 25, progress: (s) => [s.hardCorrect, 25] },
  { id: 'fast-20', name: 'Raciocínio rápido', desc: 'Acerte 20 questões em menos de 8 segundos.', icon: '⚡', xp: 150, coins: 80, check: (s) => s.fastCorrect >= 20, progress: (s) => [s.fastCorrect, 20] },
